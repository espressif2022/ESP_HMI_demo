...
lv_obj_t *g_wakeup_page;   // global variable
...
static bool sleep_status = false; // true: sleep, false: wakeup
...
void ui_flash_face_init(lv_obj_t *parent)
{
    ...
    g_wakeup_page = page;
    ESP_LOGI("sleep", "g_wakeup_page:%p", g_wakeup_page);
    sleep_status = true;
}
