...
__attribute__((unused)) static esp_err_t get_device_service_name(char *service_name, size_t max)
{
...
__attribute__((unused)) static char *get_device_pop(app_wifi_pop_type_t pop_type)
{
...
esp_err_t app_wifi_start(char *service_name, char *pop)
{
    ...
    if (!provisioned) {
         ...
         */
        // char *service_name = "esp-toothbrush";
