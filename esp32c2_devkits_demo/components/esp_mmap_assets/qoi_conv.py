...
class Pixel:
    ...
    def compute_hash(self) -> int:
        # print(f"The type of self.g is {type(self.g)}")
        r = int(self.r)
        g = int(self.g)
        b = int(self.b)
        a = int(self.a)
    ...
    def __encode(self) -> None:
        ...
        for i in range(self.height()):
            for j in range(self.width()):
                ...
                if array[pixel_new.compute_hash()] == pixel_new:
                    self.cases['lookup'] += 1
                    frame = bytearray(1)
                    frame[0] = pixel_new.compute_hash()
                    self.file.write(frame)
                    pixel = pixel_new
                    continue
                ...
                if pixel.a != pixel_new.a:
                    ...
                    array[pixel_new.compute_hash()] = pixel_new
                    pixel = pixel_new
                    continue
    ...
    def __decode(self) -> None:
        ...
        for i in range(image_size):
            ...
            if value == self.QOI_OP_RGB:
                ...
                array[pixel.compute_hash()] = pixel
