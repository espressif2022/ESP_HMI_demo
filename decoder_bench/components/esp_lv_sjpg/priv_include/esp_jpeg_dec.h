...
/**
 * @brief  JPEG decoder output information
 */
typedef struct {
...
/**
 * @brief      Create a JPEG decoder handle, set user configuration information to decoder handle
 *
...
/**
 * @brief      Parse JPEG header, and output information to user
 *
 * @param[in]      jpeg_dec        JPEG decoder handle
 * @param[in]      io              Pointer to io control struct
 * @param[out]     out_info        Pointer to output information struct
 *
 * @return
 *       - JPEG_ERR_OK     On success
